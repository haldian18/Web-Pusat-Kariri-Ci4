...
<body>
    ...
    <div class="container pt-5">
        ...
        <form action="/project/simpan" enctype="multipart/form-data" method="POST">
            ...
            <div class=" row mt-3 form-floatin">
                ...
                <div class="col-lg-6">
                    <input type="file" class="form-control" name="img" placeholder="Link Gambar">
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6">
                    <textarea class="form-control" name="penjelasan" name="" id="" cols="30" rows="10" placeholder="Penjelasan Gambar"></textarea>
                </div>
            </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6">
                    <input type="text" class="form-control" name="tipe" placeholder="Tipe Berita">
                </div>
            </div>
