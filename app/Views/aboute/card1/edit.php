...
<body>
    <nav class="fixed-top navbar navbar-expand-lg navbar-light bg-primary">
        <div class="container-fluid text-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <a class="btn text-warning btn-outline-light" aria-current="page" href="/auth/index">Logout</a>
                </form>
            </div>
        </div>
    </nav>
    ...
    <div class="container pt-5">
        ...
        <form action="<?php echo site_url('/project/update'); ?>" method="post">
            <div class="row mt-3 form-floatin">
                ...
                <div class=" row mt-3 form-floatin">
                    ...
                    <div class="col-lg-6">
                        <input type="file" class="form-control" name="img" placeholder="Link Gambar" value="<?= $img; ?>">
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="judul" placeholder="Judul Gambar" value="<?= $judul; ?>">
                    </div>
                </div>

                <div class="row mt-3">
                    <div class="col-lg-3">
                        <label for="floatingInput">Penjelasan Gambar</label>
                    </div>
                    <div class="col-lg-6">
                        <textarea class="form-control" name="penjelasan" placeholder="Penjelasan Gambar" value="<?= $penjelasan; ?>" cols="30" rows="10"></textarea>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6">
                        <input type="text" class="form-control" name="tipe" placeholder="Tipe Berita" value="<?= $tipe; ?>">
                    </div>
                </div>
