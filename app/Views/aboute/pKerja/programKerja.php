...
<body>
    ...
    <nav class="pt-4">
        ...
        <img src="/asset/img/program kerja.jpg" alt="..." height="100%" width="100%">
    </nav>
        ...
        <div class="row d-flex justifay-content-center">
            <div class="col-lg-12 col-xs-8">
                <div>
                    <h1>Program Kerja</h1>
                    <p>
                        Guna menunjang Program Kerja Direktur Politeknik Negeri Lampungdalam mewujudkan visi,
                        misi dan tujuan Unit Pengembangan Teknis Pusat Karir Polinela, <br> maka UPT Pusat Karir Polinela
                        menerapkan beberapa program kerja sebagai berikut:
                    </p>
                    <hr>
    ...
    <div class="row mx-4 pb-5 pt-5">
        <div class="text-center pt-3 col-sm-6">
            ...
            <!-- Youtube Vidio -->
            <iframe class="pt-3 pb-5 mx-5" width="560" height="315" src="https://www.youtube.com/embed/vT8N8LT0bp0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
