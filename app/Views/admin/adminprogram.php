        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h3 mb-0 text-gray-800">Dashboard CRUD Program Kerja</h1>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="/kerja/add/ " class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> + Add Data</a>
                    </div>
                    ...
                    <table class="table table-striped table-hover mx-auto">
                        <tr>
                            <td class="col-12">
                                ...
                                <a href="/kerja/get_edit/<?= $data['id'] ?> " class="  btn btn-primary">Edit</a>
                                <a href="/kerja/delete/<?= $data['id'] ?> " class=" btn btn btn-primary">Delete</a>
                            </td>
                        </tr>
                    </table>
