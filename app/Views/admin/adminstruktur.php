        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h3 mb-0 text-gray-800">Dashboard CRUD Struktur</h1>
                </nav>
                <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="/organisasi/add/ " class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> + Add Data</a>
                    </div>
                        ...
                        <div class="col-sm-4 col-xs-12 pb-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/organisasi/delete/<?= $data['id'] ?> " class="btn btn-primary">Delete</a>
                                </div>
                            </div>
                        </div>
                        <br>
